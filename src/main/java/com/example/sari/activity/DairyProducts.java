...
public class DairyProducts extends AppCompatActivity {
    ...
    private void showData() {
        Query dairyQuery = mDatabaseReference.child("dairy");


        options = new FirebaseRecyclerOptions.Builder<Product>().setQuery(dairyQuery, Product.class).build();
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, ViewHolder>(options) {
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
                View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_dairyproducts,parent, false);
...
//                        Toast.makeText(DairyProducts.this, "HELLO", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onItemLongClick(View view, int position) {
//                        Toast.makeText(DairyProducts.this, "LONG CLICK", Toast.LENGTH_SHORT).show();
    ...
    public void productList(View view) {
        Toast.makeText(DairyProducts.this, "Successfully Added", Toast.LENGTH_SHORT).show();
    }
