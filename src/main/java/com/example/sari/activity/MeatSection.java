...
public class MeatSection extends AppCompatActivity {
    ...
    private void showData() {
        Query meatQuery = mDatabaseReference.child("meat");


        options = new FirebaseRecyclerOptions.Builder<Product>().setQuery(meatQuery, Product.class).build();
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, ViewHolder>(options) {
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
                View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_meats,parent, false);
...
//                        Toast.makeText(MeatSection.this, "HELLO", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onItemLongClick(View view, int position) {
//                        Toast.makeText(MeatSection.this, "LONG CLICK", Toast.LENGTH_SHORT).show();
    ...
    public void productList(View view) {
        Toast.makeText(MeatSection.this, "Successfully Added", Toast.LENGTH_SHORT).show();
    }
