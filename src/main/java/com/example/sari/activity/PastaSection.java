...
public class PastaSection extends AppCompatActivity {
    ...
    private void showData() {
        Query pastaQuery = mDatabaseReference.child("pasta");


        options = new FirebaseRecyclerOptions.Builder<Product>().setQuery(pastaQuery, Product.class).build();
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, ViewHolder>(options) {
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
                View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_pasta,parent, false);
...
//                        Toast.makeText(PastaSection.this, "HELLO", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onItemLongClick(View view, int position) {
//                        Toast.makeText(PastaSection.this, "LONG CLICK", Toast.LENGTH_SHORT).show();
    ...
    public void productList(View view) {
        Toast.makeText(PastaSection.this, "Successfully Added", Toast.LENGTH_SHORT).show();
    }
}
