...
public class SpicesSection extends AppCompatActivity {
    ...
    private void showData() {
        Query spicesQuery = mDatabaseReference.child("spices");


        options = new FirebaseRecyclerOptions.Builder<Product>().setQuery(spicesQuery, Product.class).build();
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, ViewHolder>(options) {
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
                View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_spices,parent, false);
...
//                        Toast.makeText(SpicesSection.this, "HELLO", Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onItemLongClick(View view, int position) {
//                        Toast.makeText(SpicesSection.this, "LONG CLICK", Toast.LENGTH_SHORT).show();
    ...
    public void productList(View view) {
        Toast.makeText(SpicesSection.this, "Successfully Added", Toast.LENGTH_SHORT).show();
    }
}
